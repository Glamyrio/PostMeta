...
/obj/vehicle/sealed/mecha/justice
	...
	icon_state = "justice"
	icon = 'modular_meta/features/uplink_items/icons/mecha.dmi'
...
/datum/action/vehicle/sealed/mecha/invisibility
	name = "Invisibility"
	button_icon_state = "mech_phasing_off" // Я где-то потерял оригинальную иконку, поэтому используем самую похожую.
