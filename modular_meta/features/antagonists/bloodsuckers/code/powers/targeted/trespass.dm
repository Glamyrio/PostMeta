...
/datum/action/cooldown/bloodsucker/targeted/trespass/FireTargetedPower(atom/target_atom)
	...
	var/datum/effect_system/basic/steam_spread/bloodsucker/puff = new /datum/effect_system/basic/steam_spread(my_turf, 3, 0)
	puff.start()
	...
	puff = new /datum/effect_system/basic/steam_spread/(target_turf, 3, 0)
